...
@useoptic/cli/2.1.8 darwin-x64 node-v8.12.0
$ optic --help [COMMAND]
USAGE
  $ optic COMMAND
...
...
_See code: [src/commands/api/add.ts](https://github.com/opticdev/optic-cli/blob/v2.1.8/src/commands/api/add.ts)_
...
_See code: [src/commands/api/document.ts](https://github.com/opticdev/optic-cli/blob/v2.1.8/src/commands/api/document.ts)_
...
_See code: [src/commands/api/install.ts](https://github.com/opticdev/optic-cli/blob/v2.1.8/src/commands/api/install.ts)_
...
_See code: [src/commands/api/publish.ts](https://github.com/opticdev/optic-cli/blob/v2.1.8/src/commands/api/publish.ts)_
...
_See code: [src/commands/config/check.ts](https://github.com/opticdev/optic-cli/blob/v2.1.8/src/commands/config/check.ts)_
...
_See code: [src/commands/credentials/add-token.ts](https://github.com/opticdev/optic-cli/blob/v2.1.8/src/commands/credentials/add-token.ts)_
