...
@useoptic/cli/3.2.7 darwin-x64 node-v8.12.0
$ optic --help [COMMAND]
USAGE
  $ optic COMMAND
...
...
_See code: [src/commands/api/add.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/api/add.ts)_
...
_See code: [src/commands/api/document.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/api/document.ts)_
...
_See code: [src/commands/api/install.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/api/install.ts)_
...
_See code: [src/commands/api/publish.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/api/publish.ts)_
...
_See code: [src/commands/api/publishLocal.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/api/publishLocal.ts)_
...
_See code: [src/commands/api/update.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/api/update.ts)_
...
_See code: [src/commands/auth/login.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/auth/login.ts)_
...
_See code: [src/commands/auth/logout.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/auth/logout.ts)_
...
_See code: [src/commands/config/check.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/config/check.ts)_
...
_See code: [src/commands/setup/init.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/setup/init.ts)_
...
_See code: [src/commands/setup/paths.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/setup/paths.ts)_
...
_See code: [src/commands/setup/tests.ts](https://github.com/opticdev/optic-cli/blob/v3.2.7/src/commands/setup/tests.ts)_
<!-- commandsstop -->
